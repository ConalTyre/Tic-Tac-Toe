...
void CheckWin(char square[], int &result)
{
	...
	if (*(ptrSquare + 1) == *(ptrSquare + 2) &&
		*(ptrSquare + 2) == *(ptrSquare + 3)) {
		*ptrResult = 1;
	}
	else if (*(ptrSquare + 1) == *(ptrSquare + 5) && *(ptrSquare + 9)) {
		*ptrResult = 1;
	}
	else if (*(ptrSquare + 4) == *(ptrSquare + 5) && *(ptrSquare + 6)) {
		*ptrResult = 1;
	}

	else if (*(ptrSquare + 7) == *(ptrSquare + 8) && *(ptrSquare + 9)) {
		*ptrResult = 1;
		}
	else if (*(ptrSquare + 3) == *(ptrSquare + 5) && *(ptrSquare + 7)) {
		*ptrResult = 1;
	}
	else if (*(ptrSquare + 2) == *(ptrSquare + 5) && *(ptrSquare + 8)) {
		*ptrResult = 1;
	}
	else if (*(ptrSquare + 3) == *(ptrSquare + 6) && *(ptrSquare + 9)) {
		*ptrResult = 1;
	}
	else if (*(ptrSquare + 1) == *(ptrSquare + 4) && *(ptrSquare + 7)) {
		*ptrResult = 1;
	}
	else if (*(ptrSquare + 1 ) != '1' && *(ptrSquare + 4 ) != '4' && *(ptrSquare + 7) !='7' && (*(ptrSquare + 3) != '3' && *(ptrSquare + 6) != '6' && *(ptrSquare + 9) != '9') && (*(ptrSquare + 2) != '2' *(ptrSquare + 5) != '5' &&  *(ptrSquare + 8) != '8')
}
